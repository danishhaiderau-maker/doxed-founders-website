...
const states = {
  working: ['dragon-working.png', 'Building your workspace', 'Founder Dragon is flying toward the next result.'],
  success: ['dragon-success-v3.png', 'Delivered', 'The requested work has reached its destination.'],
  attention: ['dragon-attention.png', 'Founder decision needed', 'Review the pending approval to continue.'],
  error: ['dragon-attention.png', 'Blocked', 'Founder Dragon needs help reaching the destination.'],
};
const stateEvidence = {};
for (const [state, [image, title, detail]] of Object.entries(states)) {
  await evaluate(`(() => {
    const root = document.querySelector('[data-companion]');
