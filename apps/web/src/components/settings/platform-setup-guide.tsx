  ...
  return (
    <div className="text-sm text-zinc-300">
      ...
      <ol className="mt-4 space-y-4 list-none">
        ...
        <li>
          <p className="font-medium text-violet-200">2. Founder IDE + vault (optional, recommended)</p>
          <p className="mt-1 text-xs text-zinc-400">
            Download Founder IDE (Founder Node is included), choose <strong>Founder Vault</strong> storage, generate a pairing code{' '}
