      ...
      <div className="flex flex-wrap items-start justify-between gap-2">
        <div>
          ...
          <p className="mt-1 text-xs text-zinc-500">
            Same trade ID on the canonical Fly bot and Bitfinex relay — entry/exit prices, Melbourne
      ...
      {latestRows.length ? (
        <div className="mt-4 overflow-x-auto">
          <p className="mb-2 text-[10px] text-zinc-600">
            Last {latestRows.length} trades (Melbourne 24h) — trade ID must match the canonical Fly bot
          </p>
