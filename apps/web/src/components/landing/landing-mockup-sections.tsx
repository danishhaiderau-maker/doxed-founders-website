...
import { LandingFounderOsPromo } from '@/components/landing/landing-founder-os-promo';
...
export function LandingHeader() {
  return (
    <header className="sticky top-0 z-[100] border-b border-zinc-800/80 bg-[#050508]/90 backdrop-blur-xl">
