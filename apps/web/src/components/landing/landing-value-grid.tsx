...
const GRID_ALT =
  'Curated builders in public. Conviction over hype. Founder OS for shipping. Founder IDE includes the private vault, remote Node, and bring your own keys. Fund founders who deliver.';
