    ...
    <main className='min-h-screen bg-[#050508] text-zinc-100'>
      ...
      <div className='mx-auto max-w-3xl px-6 py-12'>
        <div className='rounded-2xl border border-zinc-800 bg-zinc-950/50 p-8'>
          <h2 className='text-lg font-semibold text-white'>Pair a local model with Founder IDE</h2>
          <p className='mt-2 text-sm leading-relaxed text-zinc-400'>
            Founder IDE ships with a local inference adapter that talks to llama.cpp, Ollama, and any GGUF model on
            your machine. Local models and Tab autocomplete always work — even offline or after you exhaust your
            cloud quota.
          </p>
          ...
          <ol className='mt-6 list-decimal space-y-2 pl-5 text-sm text-zinc-300'>
            <li>
              Install{' '}
              <a href='https://ollama.com' target='_blank' rel='noreferrer' className='text-violet-400 underline-offset-4 hover:underline'>
                Ollama
              </a>{' '}
              or your preferred llama.cpp runtime.
            </li>
            <li>
              Pull a model:{' '}
              <code className='rounded-md bg-zinc-900 px-1.5 py-0.5 font-mono text-xs text-emerald-300'>
                ollama pull qwen2.5-coder:7b
              </code>
            </li>
            <li>Open Founder IDE → Settings → Local models.</li>
            <li>
              Select the model and click <strong className='text-white'>Activate</strong>.
            </li>
            <li>
              The chat composer&apos;s <strong className='text-white'>Local</strong> option will now route to it.
            </li>
          </ol>

          <div className='mt-6 rounded-xl border border-zinc-800 bg-zinc-950/40 p-4'>
            <p className='text-xs text-zinc-400'>
              <strong className='text-zinc-200'>Coming soon:</strong> direct GGUF file picker, hardware-aware
              quantization suggestions, and a benchmark chart comparing models on your CPU/GPU.
            </p>
          </div>
