...
export const AGENT_REGISTRY_TARGETS = [
  ...
  },
  {
    ...
    metadataUriKey: 'agentCard' as const,
    registerUrl: 'https://aiagentsdirectory.com/',
    note: 'Manual submit — use AgentCard URL + hub link. Not a token listing.',
  },
  {
    id: 'SKILLS_SH',
    label: 'OpenServ / agent marketplaces',
    metadataUriKey: 'agentJson' as const,
    registerUrl: 'https://www.openserv.ai/',
    note: 'Apply if API + docs pass their review. DexScreener/Linktree are token promo — optional only.',
  },
] as const;
