...
export const defaultModelsOfProvider = {
	...
	// Founder-managed aliases are available on first launch. They are routed by
	// sendFounderOs.ts using the local Founder vault, so no provider key is
	// persisted in editor settings.
	openAICompatible: [
		'founder-os-auto',
		'founder-os-fast',
...
const openaiCompatible: VoidStaticProviderInfo = {
	...
	modelOptions: founderManagedModelOptions,
	providerReasoningIOSettings: {
