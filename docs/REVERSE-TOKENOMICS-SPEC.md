...
> **2026-07-21 amendment:** The working fee model is 1% of quote-side bonding-curve volume: 0.5% founder revenue, 0.25% platform USDC operating reserve, and 0.25% platform Growth Reserve. Buyback/burn is never automatic. Two incompatible supply templates are now under review: the earlier Fair Launch (80% curve, 20% graduated liquidity, no insider allocation) and the latest Founder Enterprise proposal (50% continuously vesting Founder Stewardship Vault over ten years, 40% curve, 10% graduated-liquidity reserve). The Enterprise model also proposes opt-in acquisition interest and a legally approved, fully funded snapshot/burn-to-claim stablecoin settlement. It must not be presented as equity or an acquisition-proceeds right until securities, corporate, tax, AML, and contract counsel create that legal wrapper. See [`DCF-SWAP-FEES-CUSTODY-AND-AUTHORITY.md`](./DCF-SWAP-FEES-CUSTODY-AND-AUTHORITY.md). This amendment controls over conflicting supply tables, fee tables, formulas, projections, and open-question answers below.
