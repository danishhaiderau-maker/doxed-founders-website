...
for (const [canonical, mirror, label] of [
  ...
  ...['evidence_phase_trace.py', 'microstructure_bucket_clock.py', 'microstructure_tape.py', 'paper_fill_ownership.py', 'public_quantity_metadata.py', 'score_led_paper.py'].map(name => [
