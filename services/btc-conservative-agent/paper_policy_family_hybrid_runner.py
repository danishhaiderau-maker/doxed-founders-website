"""Paper-only hybrid 33%-secure runner family tile."""
...
POLICY_ID = "OFFSET_0.03_CHASE_w234_s25_i180|HYBRID_secure_33_runner_TRAIL_1"
LANE = "FAMILY_HYBRID_RUNNER"
SPEC = PolicySpec(policy_id=POLICY_ID, lane=LANE, label="Hybrid secure 33% runner", family="HYBRID_RUNNER", entry_offset_pct=0.03, chase_windows=(2, 3, 4), chase_interval_sec=180, chase_step=0.25, initial_stop_atr_k=1.5, trail_activation_atr_k=1.0, trail_atr_k=1.0, partial_targets=((1.0, 0.33),))
