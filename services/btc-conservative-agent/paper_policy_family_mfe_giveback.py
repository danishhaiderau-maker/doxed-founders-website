...
POLICY_ID = "OFFSET_0.03_CHASE_w234_s25_i180|ATR_TP_2.5_GIVEBACK_20PCT"
LANE = "FAMILY_MFE_GIVEBACK"
SPEC = PolicySpec(policy_id=POLICY_ID, lane=LANE, label="MFE giveback 20%", family="MFE_GIVEBACK", entry_offset_pct=0.03, chase_windows=(2, 3, 4), chase_interval_sec=180, chase_step=0.25, initial_stop_atr_k=None, atr_target_k=None, mfe_giveback_fraction=0.20)
