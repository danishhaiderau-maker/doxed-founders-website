...
POLICY_ID = "OFFSET_0.03_CHASE_w234_s25_i180|CHANDELIER_3"
LANE = "FAMILY_CHANDELIER_3"
SPEC = PolicySpec(policy_id=POLICY_ID, lane=LANE, label="Chandelier 3 ATR", family="CHANDELIER", entry_offset_pct=0.03, chase_windows=(2, 3, 4), chase_interval_sec=180, chase_step=0.25, initial_stop_atr_k=2.0, chandelier_atr_k=3.0, trail_activation_atr_k=1.0)
